...
(function () {
	...
	var OUTPUT_ELEMENT_ID = "infocards-section";
	var OUTPUT_ELEMENT_STYLE_OLD = "float: left; width: 70%;";
	var MATERIAL_MORE_BUTTON_SELECTOR = "#expand";
	var MATERIAL_LESS_BUTTON_SELECTOR = "#collapse";
	...
	function generateRank(tag, id) {
		...
		if (youtubeSearchData[id]) {
			...
			// get tags div
			var divobj = document.getElementById(OUTPUT_ELEMENT_ID);
